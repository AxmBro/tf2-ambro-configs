Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"150 214 36 255" // Highlight color
		...
		"G_Overheal"			"35 150 228 255" // Overhealed health value color
		"G_LowHealthValue"		"255 196 196 255" // Low health value color
		"G_AmmoClipValue"		"150 214 36 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"35 150 228 255" // Ammo in reserve value color
		"G_LowAmmo"				"225 51 26 255" // Low ammo color
		"G_MetalValue"			"255 255 255 255" // Metal color
		"G_MetalIcon"			"255 255 255 255" // Metal icon color
		"G_HeadsValue"			"235 73 50 255" // Heads value color
		"G_HeadsLabel"			"255 255 255 255" // Heads value icon color
		"G_KillstreakValue"		"35 150 228 255" // Killstreak value color
		...
		"G_Footer"					"19 21 19 255" // Menu footer color
		...
		"G_BackpackItemBg"			"55 50 45 219" // Backpack item bg color
		"G_LoadoutItemBg"			"46 43 40 255" // Loadout item bg color
		"G_MenuBg"					"30 27 27 255" // Menu bg color
		"G_MenuText"				"214 206 200 255" // Menu text color
		"G_InputText"				"0 0 0 240" // Input text color
		"G_DimmInputText"			"0 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"214 206 200 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"46 43 40 255" // Item description panel bg
		"G_ButtonBg"				"84 88 77 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"150 214 36 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"33 181 211 255" // Button selected bg color
		...
		"TFOrange"			"150 214 36 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"150 214 36 255" // Highlight color
		Slider.TextColor			"214 206 200 255" // Menu text color
		Slider.TrackColor			"214 206 200 255" // Menu text color
		Slider.DisabledTextColor1	"214 206 200 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"214 206 200 120" // Dimm Menu text color
