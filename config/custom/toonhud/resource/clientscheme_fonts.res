Scheme
{
	...
	Fonts
	{
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"ToonHUD Hemi Head Rg" [$WINDOWS] // Health Font | Primary font
				"name"			"ToonHUD Hemi Head Rg" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"ToonHUD Hemi Head Rg" [$WINDOWS] // Ammo Font | Primary font
				"name"			"ToonHUD Hemi Head Rg" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"ToonHUD Hemi Head Rg" [$WINDOWS] // Target ID health font | Primary font
				"name"			"ToonHUD Hemi Head Rg" [!$WINDOWS] // Target ID health font | Primary font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Karla" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"Karla" [!$WINDOWS] // Closed captions font | Secondary font
